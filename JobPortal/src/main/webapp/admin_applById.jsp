		...
		<div class="row">			
			<div class="col-12">
				<div class="card" style="background-color: white; height: auto; box-shadow: 0px 10px 15px -10px rgba(0, 0, 0, 0.5),0px -5px 15px -5px rgba(0, 0, 0, 0.5); /* Top shadow */margin-left: 30px; margin-right: 30px; border-radius: 10px;" >
						...
						<input class="form-control mt-3 search d-inline" id="search" type="text" placeholder="Search Application's...." style="width:70%; margin-left: 9%;">
				</div>
					<div class="row  ml-3 mr-3 mb-3 mt-3" id="container">
						...
						ArrayList<Applications> ap=s1.getAdminAppByID(request.getParameter("u_id"));
									...
									<div class="row">
										...
										<div class="col-4">
											...
											<form action="register" method="post">
												...
												<button class="button" type="submit" name="AdminDeleteApp"><i class="bi bi-trash"></i></button>
											</form>	
											</div>
											<%}else{ %>
											<div class="lab mt-0">
