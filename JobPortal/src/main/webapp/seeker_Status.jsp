			...
			<div class="col-12">
				<div class="card" style="background-color: white; height: auto; box-shadow: 0px 10px 15px -10px rgba(0, 0, 0, 0.5),0px -5px 15px -5px rgba(0, 0, 0, 0.5); /* Top shadow */margin-left: 30px; margin-right: 30px; border-radius: 10px;" >
					<div class="d-inline-block">
  						<a href="home.jsp"><i class="fas fa-arrow-left d-inline ml-5" style="font-size: 25px;"></i></a> <!-- Back arrow icon -->
						<input class="form-control mt-3 search d-inline" id="search" type="text" placeholder="Search Applications...." style="width:70%; margin-left: 9%;">
				</div>
